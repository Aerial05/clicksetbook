...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2025 at 05:26 PM
...
CREATE DATABASE IF NOT EXISTS `u112535700_next_gen_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `appointments` (
  ...
  `status` enum('pending','confirmed','in_progress','completed','cancelled','no_show','deleted') DEFAULT 'pending',
...
,`end_time` time
,`status` enum('pending','confirmed','in_progress','completed','cancelled','no_show','deleted')
...
(1, NULL, 'MD-2021-001', 'Cardiologist', 'Cardiology', 'MD, FACC', 10, 150.00, 'Dr. John Doe is a dedicated cardiologist with expertise in heart disease prevention and treatment.', NULL, NULL, 1, '2025-10-07 06:48:43', '2025-10-07 06:48:43'),
(2, NULL, 'MD-2021-002', 'Gynecologist', 'Obstetrics & Gynecology', 'MD, FACOG', 8, 120.00, 'Specializing in women\'s health with compassionate care.', NULL, NULL, 1, '2025-10-07 06:48:43', '2025-10-07 06:48:43'),
(3, NULL, 'MD-2021-003', 'Orthopedic Surgeon', 'Orthopedics', 'MD, FAAOS', 12, 180.00, 'Expert in joint replacement and sports medicine.', NULL, NULL, 1, '2025-10-07 06:48:43', '2025-10-07 06:48:43'),
(4, NULL, 'MD-2021-004', 'Pediatrician', 'Pediatrics', 'MD, FAAP', 6, 100.00, 'Providing quality healthcare for infants, children, and adolescents.', NULL, NULL, 1, '2025-10-07 06:48:43', '2025-10-07 06:48:43');
...
(13, 'Ultrasound', 'Non-invasive imaging used to visualize internal organs and monitor pregnancies', 'radiology', 30, 120.00, 0, NULL, 1, '2025-10-07 06:48:43', '2025-10-07 06:48:43'),
